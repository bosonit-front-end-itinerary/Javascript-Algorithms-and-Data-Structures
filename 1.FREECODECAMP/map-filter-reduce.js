...
/*Completa el código para la función squareList usando cualquier combinación de map(), filter(), y reduce(). La función debe devolver un nuevo arreglo que contenga la raíz cuadrada de solamente los enteros positivos (números decimales no son enteros) cuando se le pasa un arreglo de números reales. 
...
const squaredIntegers1 = squareList3([-3, 4.8, 5, 3, -3.2]);
console.log(squaredIntegers);